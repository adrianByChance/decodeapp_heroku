...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">Hawaii</h1>
        <div class="row center">
          <h5 class="header col s12 light">Start a journey and be Calm and Relaxed</h5>
        </div>
        <br><br>

      </div>
    </div>
    <div class="parallax"><img src="img/hawaii3.jpg" alt="Unsplashed background img 1" style="display: block; transform: translate3d(-50%, 202px, 0px);"></div>
  </div>
    <div class="container">
    <div class="section">
    ...
    <li>
      ...
      <div class="collapsible-body"><p>Welcome to Hawaii, the Aloha state. Hawaii is comprised of a chain of 132 islands. We usually think of the eight main islands when we think of Hawaii. This is not surprising as the other 124 islands only total about 3 square miles in land area.

Click for the latest Honolulu weather forecast.
Hawaii is home of the worlds most active volcano, the crater of Kilauea on Mauna Loa. Sandy beaches, towering volcanoes, and lush valleys lure thousands of tourists each year to this tropical paradise.</p></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">place</i>Journey Location</div>
      <div class="collapsible-body"><p><center> <img class="materialboxed" width="650" src="img/hawaii4.gif"></center></p></div>
    </li>
  </ul>
  ...
  <div class="parallax-container">
    <div class="parallax"><img src="img/hawaii2.jpg" alt="Unsplashed background img 1" style="display: block; transform: translate3d(-50%, 202px, 0px);"></div>
  </div>
  <div class="container">
    <div class="section">
...
<i class="large material-icons"><a href="app.html" class="material tooltipped" onclick="Materialize.showStaggeredList('#staggered-test'), Materialize.toast('Select A Place', 5000, 'rounded');" data-position="left" data-delay="50" data-tooltip="Return">replay</a></i>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="img/hawaii1.jpg" alt="Unsplashed background img 3" style="display: block; transform: translate3d(-50%, 30px, 0px);"></div>
  </div>
  </div>

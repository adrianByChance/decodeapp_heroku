...
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">Amsterdam</h1>
        <div class="row center">
          <h5 class="header col s12 light">Start a journey and be at Peace</h5>
        </div>
        <br><br>

      </div>
    </div>
    <div class="parallax"><img src="img/amster2.jpeg" alt="Unsplashed background img 1" style="display: block; transform: translate3d(-50%, 202px, 0px);"></div>
  </div>
    <div class="container">
    <div class="section">
    ...
    <li>
      ...
      <div class="collapsible-body"><p>Open-hearted, welcoming, and prosperous, Amsterdam is a good-time city that merrily opens its arms to all comers. It embraces its tourists, its cyclists, its boat-folk, and its multicultural community. It is friendly, unflappable, and approachable; a city confident in its own skin but with one eye fixed on the future, buzzing with creativity and bonhomie.</p></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">place</i>Journey Location</div>
      <div class="collapsible-body"><p><center> <img class="materialboxed" width="650" src="img/amster4.png"></center></p></div>
    </li>
  </ul>
  ...
  <div class="parallax-container">
    <div class="parallax"><img src="img/amster3.jpg" alt="Unsplashed background img 1" style="display: block; transform: translate3d(-50%, 202px, 0px);"></div>
  </div>
  <div class="container">
    <div class="section">
...
<i class="large material-icons"><a href="app.html" class="material tooltipped" onclick="Materialize.showStaggeredList('#staggered-test'), Materialize.toast('Select A Place', 5000, 'rounded');" data-position="left" data-delay="50" data-tooltip="Return">replay</a></i>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="img/amster1.jpg" alt="Unsplashed background img 3" style="display: block; transform: translate3d(-50%, 30px, 0px);"></div>
  </div>
  </div>
